...
template <> constexpr inline auto HomePage::qt_create_metaobjectdata<qt_meta_tag_ZN8HomePageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'showAddGraphPage'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'showTraversePage'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'showShortestPathPage'
        ...
        // Slot 'onCanvasClicked'
        QtMocHelpers::SlotData<void(QPointF)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QPointF, 13 },
        }}),
    };
...
void HomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showAddGraphPage(); break;
        case 2: _t->showTraversePage(); break;
        case 3: _t->showShortestPathPage(); break;
        case 4: _t->goBack(); break;
        case 5: _t->logout(); break;
        case 6: _t->onAddCity(); break;
        case 7: _t->onAddEdge(); break;
        case 8: _t->onDeleteCity(); break;
        case 9: _t->onDeleteEdge(); break;
        case 10: _t->onCanvasClicked((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1]))); break;
        default: ;
        }
    }
}
